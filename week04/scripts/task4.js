...
myInfo.hobbies.forEach((hobby) => {
    const myHobby = document.createElement("li");
...
myInfo.placesLived.forEach((placeLived) => {
    const livedPlace = document.createElement("dt");
    livedPlace.textContent = placeLived.place;

    const lengthLived = document.createElement("dd");
